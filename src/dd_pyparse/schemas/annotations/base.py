...
class Annotation(BaseModel):
    ...
    name: Optional[str] = Field(None, description="Name of the model that created the annotation")
    version: Optional[str] = Field(None, description="Version of the model that created the annotation")
